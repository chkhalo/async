...
abstract class Mage_Core_Block_Abstract extends Varien_Object
{
    ...
    public function setAsync($param = true)
    {
        $this->_async = true;
        return $this;
    }

    protected $_asyncRenderFlag = false;

    public function getAsyncRenderFlag()
    {
        return $this->_asyncRenderFlag;
    }

    public function setAsyncRenderFlag($param = true)
    {
        $this->_asyncRenderFlag = true;
        return $this;
    }
